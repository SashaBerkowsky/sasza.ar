...
lately i’ve been really into _C_, _rust_ and _go_. it’s been especially fun for me getting to learn and compare an older (but still highly relevant) system’s programming language like _C_ and see (get it?) the way that it diverges from its modern counterparts, particulary in terms of sintax and memory management.
