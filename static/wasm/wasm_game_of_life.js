...
export class Universe {
     ...
     * @param {number} column
     */
    spawn_glider(row, column) {
        wasm.universe_spawn_glider(this.__wbg_ptr, row, column);
    }
    /**
     * @param {number} row
     * @param {number} column
     */
    spawn_pulsar(row, column) {
        wasm.universe_spawn_pulsar(this.__wbg_ptr, row, column);
    }
    /**
     * @param {number} width
     * @param {number} height
    ...
    nuke() {
        wasm.universe_nuke(this.__wbg_ptr);
    }
    tick() {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_alert_990325db85acb43b = function(arg0, arg1) {
